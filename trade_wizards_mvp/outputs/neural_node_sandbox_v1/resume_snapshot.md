Trade Wizards — neural_node_sandbox_v1

- Built a node-based strategy sandbox with neural-network decision nodes for stock signal generation.
- Processed 14,824 OHLCV rows across 12 tickers with config-driven cleaning and cached features (features_31875dabd84a.parquet).
- Ran a backtesting workflow with cumulative return 33.66%, max drawdown -9.78%, and trade win rate 61.65%.
